...
class Model():
    ...
    def train(self, input_data, target, enc_optim, gen1_optim, gen2_optim, criterion):
        ...
        for i in range(input_length):
            ...
            loss += criterion(gen1_output, input_data[i])
    ...
    def trainIters(self, training_data, print_every=1000, plot_every=100, learning_rate=0.01):
        ...
        for i in range(len(indices)):
            ...
            latent_z, gen1_hid_states, gen2_hid_states = self.train(input_data, 1, enc_optim, gen1_optim, gen2_optim, criterion)
