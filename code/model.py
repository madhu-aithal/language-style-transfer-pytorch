...
class Model():
    ...
    def train_one_batch(self, training_data, learning_rate, sentiment):
        # batch_loss_total = 0  
        ...
        hidden_states_original, loss_original = self.generate_x(latent_z_original, training_data, criterion, teacher_forcing=True)
        hidden_states_translated, loss_translated = self.generate_x(latent_z_translated, training_data, criterion, teacher_forcing=False)
    ...
    def train_max_epochs(self, args, train0, train1, vocab, no_of_epochs):
        ...
        gen1_optim = optim.SGD(self.generator1.parameters(), lr=args.learning_rate)
        ...
        for iter in range(no_of_epochs):
            ...
            for batch0, batch1 in zip(batches0, batches1):
                ...
                h1, h1_tilde, loss0 = self.train_one_batch(batch0_input, args.learning_rate, 1)
                h2, h2_tilde, loss1 = self.train_one_batch(batch1_input, args.learning_rate, 2)
