...
class Model():
    ...
    def train_max_epochs(self, args, train0, train1, vocab, no_of_epochs):
        ...
        for iter in range(no_of_epochs):
            ...
            batches0, batches1, order0, order1 = get_batches(train0, train1, vocab.word2id,
            ...
            for batch0, batch1 in zip(batches0, batches1):
                ...
                loss0 = self.train_one_batch(batch0_input, 0.1)
                loss1 = self.train_one_batch(batch1_input, 0.1)
