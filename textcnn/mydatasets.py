...
class MR(TarDataset):
    ...
    dirname = '/home/madhu/language-style-transfer-pytorch/data/yelp/'
    ...
    def __init__(self, text_field, label_field, path=None, examples=None, **kwargs):
        ...
        if examples is None:
            ...
            examples = []
            with open(os.path.join(path, 'sentiment.train.0'), errors='ignore') as f:
                examples += [
                    data.Example.fromlist([line, 'negative'], fields) for line in f]
            with open(os.path.join(path, 'sentiment.train.1'), errors='ignore') as f:
                examples += [
